        ...
        <div class="row">
            ...
            <div class="col-sm-3" style="padding-left:3%;" id="razon-social-div">
                <div class="entradas-de-texto-govco">
                    ...
                    <input type="date" id="razon-social-id" name="fecha_de_retiro"
                        placeholder="Ejemplo: Campo de texto" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3" style="padding-left:10%;" id="numvehiculos">
                <div class="entradas-de-texto-govco">
        ...
        <div class="row" style="padding-left:9.5%;">
            <div class="col-sm-2">
                <div class="entradas-de-texto-govco">
                    ...
                    <input class="form-control" type="number" name="Ancho" id="Ancho"
                        placeholder="Ejemplo: Campo de texto"
                        oninput="calcularAreaTotal('Area_Total', 'Ancho', 'Alto')" />
            ...
            <div class="col-sm-2" style="padding-left:1%;">
                <div class="entradas-de-texto-govco">
                    ...
                    <input type="number" name="Alto" id="Alto" placeholder="Ejemplo: Campo de texto"
                        oninput="calcularAreaTotal('Area_Total', 'Ancho', 'Alto')" />
            ...
            <div class="col-sm-2" style="padding-left:1%;">
                <div class="entradas-de-texto-govco">
                    ...
                    <input class="form-control" type="text" name="Area_Total" id="Area_Total"

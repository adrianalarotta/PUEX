<x-layouts.app>
  ...
  <form action="{{route('solicitudes.store')}}" id="myForm" enctype="multipart/form-data" method="POST">
    ...
    <div class="row" style="padding-left:9.5% ;">
      <div class="col-sm-2">
        <div class="entradas-de-texto-govco">
          ...
          <input class="form-control" type="number" id="Ancho_fachada" name="Ancho_fachada" placeholder="Ejemplo: Campo de texto" oninput="calcularAreaTotal('Area_Total_fachada', 'Ancho_fachada', 'Alto_fachada')" />
          <p class="error" id="Ancho_fachadaError"></p>
        </div>
      </div>
      ...
      <div class="col-sm-2" >
        <div class="entradas-de-texto-govco">
          ...
          <input class="form-control" type="number" id="Alto_fachada" name="Alto_fachada" placeholder="Ejemplo: Campo de texto" oninput="calcularAreaTotal('Area_Total_fachada', 'Ancho_fachada', 'Alto_fachada')" />
          <p class="error" id="Alto_fachadaError"></p>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-sm-3" style="padding-left:10%; padding-top:2%;" id="numvehiculos">
        <div class="entradas-de-texto-govco">
      ...
      <div class="col-sm-3" style="padding-left:1%; padding-top:4%;" id="numvehiculos">
  ...
  <script>
    document.getElementById('submitButton').addEventListener('click', function(e) {
       ...
       var direccion2 = document.getElementById('direccion2');
        ...
        var Alto = document.getElementById('Alto_fachada');
        var Alto = document.getElementById('Ancho_fachada');
        ...
        Alto_fachada.classList.remove('error-border');
        Ancho_fachada.classList.remove('error-border');
        ...
        Alto_fachada.innerText = "";
        Ancho_fachadaError.innerText = "";
        ...
        if (Alto_fachada.value === "") {
          Alto_fachada.classList.add('error-border');
          Alto_fachada.innerText = "Este campo es requerido.";
            isValid = false;
        }


        if (Ancho_fachada.value === "") {
          Ancho_fachada.classList.add('error-border');
          Ancho_fachadaError.innerText = "Este campo es requerido.";
            isValid = false;
        }
